...
mode 80,15
echo.
echo				[40m[] Checking For Updates[0m
timeout 2 >nul
goto MENU
...
echo.
echo.
echo				[30m[] LOGOUT DISCORD ACCOUNTS[0m
timeout 2 >nul
goto CLEAN/SPOOF
...
echo.
echo.
echo				[30m[] FiveM Rockstar Account Unlinked[0m
timeout 2 >nul
goto CITIZENFX
...
echo.
echo.
echo				[30m[] Xbox & Microsoft files removed[0m
timeout 2 >nul
goto DISCORD
...
echo.
echo.
echo				[30m[] discord files removed[0m
timeout 2 >nul
goto CACHE
